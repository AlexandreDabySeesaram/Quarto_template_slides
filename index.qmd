...
* [With a different color]{.warning}
...
::: {.column width="55%"}
* Still using column to organise content
...
* More animation exist, including
  * Morphing
    * To link piece of slide through the animation
  * Fade-in-then-out
...
* You can easily cite items from a `.bib` file, which then appear in the bibliography list.[@ladevezeFamilleDalgorithmesMecanique1985;@chinestaShortReviewModel2011]
...
* Here the target shape and position of the morphing animation is set
...
::: {.fragment fragment-index=1 .fade-in}
1. We start with the taget of the morphing
...
::: {.column width="50%"}
* Interactive plots
  * Pan, zoom-in, explore the plots, click on legend

:::

::: {.column width="50%"}
* I recommand saving csv from the results and loading them to create the plots
:::
...
* You can also use html `iframe` to embeded 3D html 
